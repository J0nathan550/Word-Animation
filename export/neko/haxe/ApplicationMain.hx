...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Nikita Gay", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Nikita Gay", null, 1920, 1080);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "4";
		app.meta["company"] = "J0nathan550";
		app.meta["file"] = "Nikita Gay";
		app.meta["name"] = "Nikita Gay";
